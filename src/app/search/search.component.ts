...
export class SearchComponent implements OnInit {
  ...
  @ViewChild("noResultsTemplate", { static: false })
  private noResultsTemplate: TemplateRef<any>;
  ...
  ngOnInit() {
    ...
    this.domain = this.getDomain(
      this.navigationModel.navigationLinks,
      domain ? domain : "all"
    );
    ...
    this.listModel = resultsListConfigMap.get(this.domain.id)
      ? resultsListConfigMap.get(this.domain.id)
      : resultsListConfigMap.get("all");
  ...
  search() {
    this.router.navigate(["/search"], {
      queryParams: { index: this.service.domain, keyword: "hello" },
    });
  }
  ...
  subDomainSelected(subDomain: NavigationLink) {
    ...
    this.listModel = resultsListConfigMap.get(subDomain.id)
      ? resultsListConfigMap.get(subDomain.id)
      : resultsListConfigMap.get("all");
  ...
  onDialogChange($event: SdsDialogRef<any>) {
    ...
    if ($event) {
      ...
      $event
        ...
        .toPromise()
        .then(() => {
          this.preResponsiveDialogOpenSnapshot.filterModel = JSON.parse(
