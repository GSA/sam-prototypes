...
import { ContractDataFiltersModule } from './contract-data-filters.module';

@Injectable({
  providedIn: ContractDataFiltersModule
})
export class ContractDataFiltersService implements SearchFiltersWrapperService {
