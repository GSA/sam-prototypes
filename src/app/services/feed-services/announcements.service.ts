...
import { FeedItem, FeedItemType, FeedService, Domain } from '../interfaces/public-apis';

@Injectable({
  providedIn: FeedServicesModule
})
export class AnnouncementsService implements FeedService {
    ...
    announcements: FeedItem[] = [
    	{
    		  ...
    		  mode: NavigationMode.EXTERNAL,
  			  id: "ANN0001",
          itemType: FeedItemType.Announcement,
