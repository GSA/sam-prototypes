...
@NgModule({
  declarations: [EntityRegistrationWorkspaceComponent, EntityRegistrationFiltersComponent],
  imports: [
    CommonModule,
    RouterModule,
    FormlyModule,
  ...
  exports: [EntityRegistrationWorkspaceComponent, EntityRegistrationFiltersComponent],
