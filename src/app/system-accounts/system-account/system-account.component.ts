          ...
          fieldGroup: [
            ...
            },
            {
              ...
              templateOptions: {
                ...
                description: 'Provide the name and version number of the interfacing system (COTS, GOTS, or other product) for inclusion in our system security plan.',
                placeholder: 'e.g. None',
                required: true
              }
            },
            {
              ...
              templateOptions: {
                ...
                description: 'Provide a brief description of the interfacing system and what it does. This may be taken directly from your system security plan, if you have one.',
                placeholder: 'e.g. The IRS stated in a current MOU that their system tracks all incoming commitment requsts and captures the information necessary to make awards.',
                required: true
              }
            }
          ],
          ...
          fieldGroup: [
            {
              ...
              templateOptions: {
                ...
                description: 'Select the federal department, independent agency, sub-tier or office responsible for managing this account.',
                placeholder: 'e.g. None',
                required: true
              }
            },
            {
              ...
              templateOptions: {
                ...
                description: 'Select up to two of your system administrators to own this account. Only people who have a user account and system administrator role are available for selection.',
                placeholder: 'e.g. None',
                required: true
              }
            },
            {
              ...
              templateOptions: {
                ...
                description: 'Select up to three of your system managers to help manage this account. Only people who have a user account and a system manager role are available for selection.',
                placeholder: 'e.g. None',
                required: true
              }
            }
          ...
          fieldGroup: [
            {
              ...
              templateOptions: {
                label: 'IP Address',
                description: 'Provide the dedicated static IP address used by your system. All system to system requests must use this IP address.',
                required: true
              },
            },
            {
              ...
              templateOptions: {
		        ...
		        description: 'Identify whether the connection between the two systems is web-based (HTTP, HTTPS, web service) or a persistent connection (T3, T1, VPN, SFTP).',
		        required: true,
		        options: [
            ...
            },
            {
              ...
              templateOptions: {
                ...
                placeholder: 'e.g. The CWS currently resides at NIH Building 1237 in Bethesda, Maryland',
                required: true
              }
            },
            {
				...
				wrappers: ['form-field'],
      			templateOptions: {
        			...
        			description: 'Provide the name and email address of the individual responsible for the security of the interfacing system (the ISSO, for example).',
        			hideOptional: true
			    },
			    fieldGroup: [
			    	{
