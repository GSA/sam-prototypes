...
import { EntityThreeSixtyServiceModule } from "./services/entity-three-sixty-service/entity-three-sixty-service.module";
...
@NgModule({
  declarations: [
    EntityThreeSixtyComponent,
    EntityThreeSixtySubheaderComponent,
    EntityRegistrationSummaryComponent,
    SummaryReviewListComponent,
    SummaryAddressesComponent,
    EntityThreeSixtyNavigationComponent,
  ],
  imports: [
    CommonModule,
    RouterModule,
